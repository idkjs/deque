...
function is_empty(param) {
  var d = param._0;
  if (d.TAG === /* Suffix */0) {
    return Dequeue_internal.is_empty(d._0);
  } else {
    return false;
  }
}
...
function green_prefix_cons(x, param) {
  return {
          ...
          _2: param._1,
          _3: param._2,
          _4: Dequeue_internal.cons(param._3, param._4)
        };
}
    ...
    case /* P4 */2 :
        return /* Any */{
                _0: {
                  ...
                  _2: p._1,
                  _3: p._2,
                  _4: Dequeue_internal.cons(p._3, p._4)
                }
              };
  ...
  switch (t.TAG | 0) {
    case /* Suffix */0 :
        return /* T */{
                _0: {
                  TAG: /* Suffix */0,
                  _0: Dequeue_internal.cons(x, t._0)
                }
              };
    case /* R */1 :
        var match = t._0;
  ...
  switch (t$1.TAG | 0) {
    case /* Suffix */0 :
        return /* Any_kont */{
                _0: {
                  TAG: /* Suffix */0,
                  _0: Dequeue_internal.snoc(t$1._0, x)
                }
              };
    case /* R */1 :
        var match = t$1._0;
        var s = Dequeue_internal.snoc(match._2, x);
        return /* Any_kont */{
                _0: {
                  TAG: /* R */1,
                  _0: /* Triple */{
    ...
    case /* Y */2 :
        var match$1 = t$1._0;
        var s$1 = Dequeue_internal.snoc(match$1._2, x);
        return /* Any_kont */{
                _0: {
                  TAG: /* Y */2,
                  _0: /* Triple */{
    ...
    case /* G */3 :
        var match$2 = t$1._0;
        var s$2 = Dequeue_internal.snoc(match$2._2, x);
        return /* Any_kont */{
                _0: {
                  TAG: /* G */3,
                  _0: /* Triple */{
    ...
    case /* Yr */4 :
        var match$3 = t$1._0;
        var s$3 = Dequeue_internal.snoc(match$3._2, x);
        return /* Any_kont */{
                _0: {
                  TAG: /* Yr */4,
                  _0: /* Triple */{
...
function join_any(child, s, ty) {
  var match = Dequeue_internal.uncons(s);
  var match$1;
  if (match !== undefined) {
    var x = match[0];
    var match$2 = Dequeue_internal.uncons(match[1]);
...
function concat_kont(x, ty) {
  switch (x.TAG | 0) {
    case /* Suffix */0 :
        var match = Dequeue_internal.uncons(x._0);
        if (match === undefined) {
          return ty;
        }
        var x$1 = match[0];
...
function concat(x, ty) {
  ...
  switch (x$1.TAG | 0) {
    case /* Suffix */0 :
        var match = Dequeue_internal.uncons(x$1._0);
        if (match === undefined) {
          return ty;
        }
        var x$2 = match[0];
...
function green_pop(param) {
  ...
  var b = param._1;
  var a = param._0;
  var match = Dequeue_internal.uncons(param._4);
  if (match !== undefined) {
    return [
            a,
            /* Any */{
...
function green_of_red(param) {
    ...
    switch (p.TAG | 0) {
      ...
      case /* P3 */1 :
          p$1 = {
            ...
            _2: p._0,
            _3: p._1,
            _4: Dequeue_internal.cons(p._2, Dequeue_internal.empty)
          };
          break;
      case /* P4 */2 :
          p$1 = {
            ...
            _2: p._0,
            _3: p._1,
            _4: Dequeue_internal.cons(p._2, Dequeue_internal.cons(p._3, p._4))
          };
          break;
  ...
  if (small.TAG === /* Suffix */0) {
    var match$5 = Dequeue_internal.uncons(small._0);
    if (match$5 === undefined) {
      return {
              TAG: /* Suffix */0,
              _0: Dequeue_internal.cons(a, Dequeue_internal.cons(b, s))
            };
    }
    ...
    switch (p$2.TAG | 0) {
      ...
      case /* P3 */1 :
          p$3 = {
            ...
            _2: p$2._0,
            _3: p$2._1,
            _4: Dequeue_internal.cons(p$2._2, Dequeue_internal.empty)
          };
          break;
      case /* P4 */2 :
          p$3 = {
            ...
            _2: p$2._0,
            _3: p$2._1,
            _4: Dequeue_internal.cons(p$2._2, Dequeue_internal.cons(p$2._3, p$2._4))
          };
          break;
  ...
  switch (p$4.TAG | 0) {
    ...
    case /* P3 */1 :
        p$5 = {
          ...
          _2: p$4._0,
          _3: p$4._1,
          _4: Dequeue_internal.cons(p$4._2, Dequeue_internal.empty)
        };
        break;
    case /* P4 */2 :
        p$5 = {
          ...
          _2: p$4._0,
          _3: p$4._1,
          _4: Dequeue_internal.cons(p$4._2, Dequeue_internal.cons(p$4._3, p$4._4))
        };
        break;
...
function uncons(t) {
  ...
  switch (t$1.TAG | 0) {
    case /* Suffix */0 :
        var match = Dequeue_internal.uncons(t$1._0);
        if (match !== undefined) {
          return [
                  match[0],
                  /* T */{
